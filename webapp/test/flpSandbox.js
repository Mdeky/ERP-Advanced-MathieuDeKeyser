		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movements App",
									"targetURL": "#erpadvancedmathieudekeyser-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"erpadvancedmathieudekeyser-display": {
								"semanticObject": "erpadvancedmathieudekeyser",
								"action": "display",
								"description": "Project Opdracht ERP Advanced by Mathieu De Keyser",
								"title": "Movements App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=erpadvancedmathieudekeyser",
									"url": sap.ui.require.toUrl("erpadvancedmathieudekeyser")
								}
							}
						}
					}
